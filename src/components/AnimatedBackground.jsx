...
export function AnimatedBackground() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-burgundy-950 via-black to-burgundy-900" />
      {!reduced && (
        <>
          <motion.div
            className="absolute -left-1/4 top-0 h-[60vh] w-[60vh] rounded-full bg-red-900/30 blur-[120px]"
            animate={{ x: [0, 80, 0], y: [0, 40, 0] }}
            transition={{ duration: 18, repeat: Infinity, ease: 'easeInOut' }}
          />
          <motion.div
            className="absolute -right-1/4 bottom-0 h-[50vh] w-[50vh] rounded-full bg-red-700/20 blur-[100px]"
